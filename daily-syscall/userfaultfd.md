...
## implementation
[Bootlin](https://elixir.bootlin.com/linux/v6.14.7/source/fs/userfaultfd.c#L2170)
...
|new_userfaultfd|file|f_mode|https://elixir.bootlin.com/linux/v6.14.7/source/fs/userfaultfd.c#L2145|true|true|
|new_userfaultfd|task_struct|mm|https://elixir.bootlin.com/linux/v6.14.7/source/fs/userfaultfd.c#L2109|true|true|
|new_userfaultfd|task_struct|mm|https://elixir.bootlin.com/linux/v6.14.7/source/fs/userfaultfd.c#L2129|true|true|
|new_userfaultfd|userfaultfd_ctx|refcount|https://elixir.bootlin.com/linux/v6.14.7/source/fs/userfaultfd.c#L2123|false|false|
|new_userfaultfd|userfaultfd_ctx|flags|https://elixir.bootlin.com/linux/v6.14.7/source/fs/userfaultfd.c#L2124|false|false|
|new_userfaultfd|userfaultfd_ctx|features|https://elixir.bootlin.com/linux/v6.14.7/source/fs/userfaultfd.c#L2125|false|false|
|new_userfaultfd|userfaultfd_ctx|released|https://elixir.bootlin.com/linux/v6.14.7/source/fs/userfaultfd.c#L2126|false|false|
|new_userfaultfd|userfaultfd_ctx|map_changing_lock|https://elixir.bootlin.com/linux/v6.14.7/source/fs/userfaultfd.c#L2127|false|false|
|new_userfaultfd|userfaultfd_ctx|mmap_changing|https://elixir.bootlin.com/linux/v6.14.7/source/fs/userfaultfd.c#L2128|false|false|
|new_userfaultfd|userfaultfd_ctx|mm|https://elixir.bootlin.com/linux/v6.14.7/source/fs/userfaultfd.c#L2129|false|false|
|new_userfaultfd|userfaultfd_ctx|mm|https://elixir.bootlin.com/linux/v6.14.7/source/fs/userfaultfd.c#L2144|true|true|
