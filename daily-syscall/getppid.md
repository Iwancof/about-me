...
## implementation
[Bootlin](https://elixir.bootlin.com/linux/v6.14.7/source/kernel/sys.c#L986)
...
|--|--|--|--|--|--|
|__do_sys_getppid|task_struct|real_parent|https://elixir.bootlin.com/linux/v6.14.7/source/kernel/sys.c#L991|true|true|
...
|__do_sys_getppid|task_struct|real_parent|https://elixir.bootlin.com/linux/v6.14.7/source/kernel/sys.c#L991|false|false|
