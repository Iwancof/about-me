...
## implementation
[Bootlin](https://elixir.bootlin.com/linux/v6.14.7/source/kernel/sys.c#L910)
...
|__sys_setfsuid|task_struct|cred|https://elixir.bootlin.com/linux/v6.14.7/source/kernel/sys.c#L881|true|true|
|__sys_setfsuid|cred|user_ns|https://elixir.bootlin.com/linux/v6.14.7/source/kernel/sys.c#L882|true|true|
|__sys_setfsuid|cred|user_ns|https://elixir.bootlin.com/linux/v6.14.7/source/kernel/sys.c#L884|true|true|
|__sys_setfsuid|cred|user_ns|https://elixir.bootlin.com/linux/v6.14.7/source/kernel/sys.c#L894|true|true|
|__sys_setfsuid|cred|fsuid|https://elixir.bootlin.com/linux/v6.14.7/source/kernel/sys.c#L896|false|false|
|__sys_setfsuid|cred|fsuid|https://elixir.bootlin.com/linux/v6.14.7/source/kernel/sys.c#L882|true|true|
|__sys_setfsuid|cred|fsuid|https://elixir.bootlin.com/linux/v6.14.7/source/kernel/sys.c#L893|true|true|
|__sys_setfsuid|cred|fsuid|https://elixir.bootlin.com/linux/v6.14.7/source/kernel/sys.c#L895|true|true|
|__sys_setfsuid|cred|euid|https://elixir.bootlin.com/linux/v6.14.7/source/kernel/sys.c#L892|true|true|
|__sys_setfsuid|cred|suid|https://elixir.bootlin.com/linux/v6.14.7/source/kernel/sys.c#L893|true|true|
|__sys_setfsuid|cred|uid|https://elixir.bootlin.com/linux/v6.14.7/source/kernel/sys.c#L892|true|true|
