...
## implementation
[Bootlin](https://elixir.bootlin.com/linux/v6.14.7/source/fs/xattr.c#L863)
...
|xattr_permission|inode|i_mode|https://elixir.bootlin.com/linux/v6.14.7/source/fs/xattr.c#L149|true|true|
|xattr_permission|inode|i_mode|https://elixir.bootlin.com/linux/v6.14.7/source/fs/xattr.c#L147|true|true|
|do_getxattr|xattr_name|name|https://elixir.bootlin.com/linux/v6.14.7/source/fs/xattr.c#L773|false|false|
|do_getxattr|(unnamed class/struct/union)|value|https://elixir.bootlin.com/linux/v6.14.7/source/fs/xattr.c#L789|true|true|
|do_getxattr|kernel_xattr_ctx|size|https://elixir.bootlin.com/linux/v6.14.7/source/fs/xattr.c#L791|true|true|
|do_getxattr|kernel_xattr_ctx|size|https://elixir.bootlin.com/linux/v6.14.7/source/fs/xattr.c#L789|true|true|
|do_getxattr|kernel_xattr_ctx|size|https://elixir.bootlin.com/linux/v6.14.7/source/fs/xattr.c#L787|true|true|
|do_getxattr|kernel_xattr_ctx|size|https://elixir.bootlin.com/linux/v6.14.7/source/fs/xattr.c#L785|true|true|
|do_getxattr|kernel_xattr_ctx|size|https://elixir.bootlin.com/linux/v6.14.7/source/fs/xattr.c#L779|true|true|
|do_getxattr|kernel_xattr_ctx|size|https://elixir.bootlin.com/linux/v6.14.7/source/fs/xattr.c#L777|true|true|
|do_getxattr|kernel_xattr_ctx|size|https://elixir.bootlin.com/linux/v6.14.7/source/fs/xattr.c#L776|true|true|
|do_getxattr|kernel_xattr_ctx|size|https://elixir.bootlin.com/linux/v6.14.7/source/fs/xattr.c#L778|false|false|
|do_getxattr|kernel_xattr_ctx|kname|https://elixir.bootlin.com/linux/v6.14.7/source/fs/xattr.c#L773|true|true|
|__do_sys_getxattrat|xattr_args|size|https://elixir.bootlin.com/linux/v6.14.7/source/fs/xattr.c#L885|true|true|
|__do_sys_getxattrat|xattr_args|value|https://elixir.bootlin.com/linux/v6.14.7/source/fs/xattr.c#L885|true|true|
|__do_sys_getxattrat|xattr_args|flags|https://elixir.bootlin.com/linux/v6.14.7/source/fs/xattr.c#L881|true|true|
|path_getxattrat|fd|word|https://elixir.bootlin.com/linux/v6.14.7/source/fs/xattr.c#L854|true|true|
|vfs_posix_acl_to_xattr|posix_acl_xattr_entry|e_id|https://elixir.bootlin.com/linux/v6.14.7/source/fs/posix_acl.c#L926|false|false|
|vfs_posix_acl_to_xattr|posix_acl_xattr_entry|e_id|https://elixir.bootlin.com/linux/v6.14.7/source/fs/posix_acl.c#L922|false|false|
